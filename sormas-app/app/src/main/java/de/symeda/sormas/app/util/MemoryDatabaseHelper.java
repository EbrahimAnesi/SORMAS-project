...
class SampleTestGenerator extends BaseDataGenerator {
    ...
    private static SampleTestType getRandomSampleTestType() {
...
class SampleGenerator extends BaseDataGenerator {
    ...
    private static SampleMaterial getRandomSampleMaterial() {
    ...
    private static SpecimenCondition getRandomSpecimenCondition() {
    ...
    private static SampleSource getRandomSampleSource() {
...
class PersonGenerator extends BaseDataGenerator {
    ...
    public static void initialize() {
        for (int i = 0; i < DEFAULT_RECORD_NUMBER; i++) {
            ...
            data1.setBirthdateDD(getRandomDate().getDate());
            data1.setBirthdateMM(getRandomDate().getMonth());
            data1.setBirthdateYYYY(getRandomDate().getYear());
    ...
    private static ApproximateAgeType getRandomApproximateAgeType() {
    ...
    private static PresentCondition getRandomPresentCondition() {
    ...
    private static BurialConductor getRandomBurialConductor() {
    ...
    private static DeathPlaceType getRandomDeathPlaceType() {
    ...
    private static OccupationType getRandomOccupationType() {
...
class ContactGenerator extends BaseDataGenerator {
    ...
    private static ContactRelation getContactRelation() {
    ...
    private static ContactClassification getContactClassification() {
    ...
    private static FollowUpStatus getFollowUpStatus() {
    ...
    private static ContactProximity getContactProximity() {
...
class EventGenerator extends BaseDataGenerator {
    ...
    private static EventStatus getEventStatus() {
    ...
    private static TypeOfPlace getTypeOfPlace() {
