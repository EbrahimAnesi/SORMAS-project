...
public class UserReportDialog extends AbstractDialog {
	...
	public UserReportDialog(final FragmentActivity activity, String viewName, String uuid) {
		super(
			...
			R.layout.dialog_user_report_layout,
			R.layout.dialog_root_two_button_panel_layout,
			R.string.heading_user_report,
			...
			DefaultAsyncTask executor = new DefaultAsyncTask(getContext()) {
				...
				public void doInBackground(TaskResultHolder resultHolder) {
					try {
						...
						((SormasApplication) getActivity().getApplication()).getFirebaseAnalytics()
							.logEvent(FirebaseEvent.USER_ERROR_REPORT, eventBundle);
